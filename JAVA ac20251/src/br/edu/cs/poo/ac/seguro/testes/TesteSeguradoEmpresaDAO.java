...
public class TesteSeguradoEmpresaDAO extends TesteDAO {
    ...
    public void teste01() {
        ...
        dao.incluir(new SeguradoEmpresa("TESTE1", null, LocalDate.now(), BigDecimal.ZERO, 
                cnpj, 1000.0, false));
    ...
    public void teste02() {
        ...
        dao.incluir(new SeguradoEmpresa("TESTE2", null, LocalDate.now(), BigDecimal.ZERO, 
                cnpj, 1001.0, false));
    ...
    public void teste03() {
        ...
        dao.incluir(new SeguradoEmpresa("TESTE3", null, LocalDate.now(), BigDecimal.ZERO, 
                cnpj, 1002.0, false));
    ...
    public void teste04() {
        ...
        dao.incluir(new SeguradoEmpresa("TESTE4", null, LocalDate.now(), BigDecimal.ZERO, 
                cnpj, 1003.0, false));
