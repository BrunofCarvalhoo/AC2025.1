...
public class TesteVeiculoDAO extends TesteDAO {
    ...
    public void teste01() {
        ...
        dao.incluir(new Veiculo(placa, 2000, null, null, CategoriaVeiculo.BASICO));
    ...
    public void teste02() {
        ...
        dao.incluir(new Veiculo(placa, 2001, null, null, CategoriaVeiculo.BASICO));
    ...
    public void teste03() {
        ...
        dao.incluir(new Veiculo(placa, 2002, null, null, CategoriaVeiculo.BASICO));
    ...
    public void teste04() {
        ...
        dao.incluir(new Veiculo(placa, 2003, null, null, CategoriaVeiculo.BASICO));
